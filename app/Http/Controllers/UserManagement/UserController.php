            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function($row){
                    $btn = '<div class="flex justify-end space-x-2">' . 
                           '<a href="' . route('users.show', $row->id) . '" class="inline-flex items-center justify-center p-2 text-sm font-medium text-white bg-gray-500 rounded-lg hover:bg-gray-600">' . config('icons.magnifying-glass') . '</a>' . 
                           '<a href="' . route('users.edit', $row->id) . '" class="inline-flex items-center justify-center p-2 text-sm font-medium text-white bg-blue-500 rounded-lg hover:bg-blue-600">' . config('icons.pen') . '</a>' . 
