    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden mb-8">
        ...
        <div class="p-6">
            ...
            <div class="mt-6 flex justify-end space-x-4">
                ...
                <button @click="generateRateAnalysis" :disabled="loading || !selectedSor || !selectedRateCard" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:opacity-50 disabled:cursor-not-allowed">
                    <span x-show="loading" class="mr-2">
                        <svg class="animate-spin h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
    ...
    function sorExport() {
        return {
            ...
            generateRateAnalysis() {
                ...
                const url = `{{ url('/export/sor') }}/${this.selectedSor}/rate-card/${this.selectedRateCard}/analysis`;
                ...
                fetch(url)
                    ...
                    .catch(error => {
                        console.error('Error:', error);
                        this.loading = false;
                        alert('Failed to generate Rate Analysis.');
                    });
            },
