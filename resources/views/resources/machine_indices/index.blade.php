...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mt-6 border-t border-gray-200 dark:border-gray-700 pt-4">
        <div class="flex items-start justify-between">
            ...
            <a href="{{ route('machine-indices.global.index') }}" class="text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 font-medium flex items-center whitespace-nowrap ml-4">
...
<script>
    ...
    function deleteIndex(id) {
        if(confirm('Are you sure you want to delete this index?')) {
            $.ajax({
                url: "/machine-indices/" + id, // Shallow route for delete
                type: 'DELETE',
                data: {
                    "_token": "{{ csrf_token() }}"
                },
    ...
    $(document).ready(function() {
        ...
        var ajaxUrl = isGlobal ? "{{ route('machine-indices.global.index') }}" : "{{ route('resources.machine-indices.index', $resource->id) }}";
        ...
        $('#indexForm').on('submit', function(e) {
            ...
            if (id) {
                url = "/machine-indices/" + id; // Shallow route for update
                method = 'PUT';
            } else {
                url = isGlobal ? "{{ route('machine-indices.global.store') }}" : "{{ route('resources.machine-indices.store', $resource->id) }}";
                method = 'POST';
            }
        ...
        $('#lockForm').on('submit', function(e) {
            ...
            var url = "/machine-indices/" + id + "/lock";
        ...
        $('#indices-table').on('click', '.edit-btn', function() {
            ...
            $.get("/machine-indices/" + id, function(data) {
