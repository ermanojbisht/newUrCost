...
@section('title', 'Manage All Machine Indices')
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white flex items-center">
                {!! config('icons.chart') !!}
                <span class="ml-2">Manage All Machine Indices</span>
            </h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                View and manage machine indices across all resources and rate cards.
            </p>
        </div>
    ...
    $(document).ready(function() {
        ...
        $('#indexForm').on('submit', function(e) {
            ...
            if (id) {
                ...
                url = "/resources/" + resourceId + "/machine-indices";
                method = 'POST';
            }
