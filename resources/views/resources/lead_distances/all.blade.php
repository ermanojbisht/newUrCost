...
@section('title', 'Manage All Lead Distances')
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white flex items-center">
                {!! config('icons.truck') !!}
                <span class="ml-2">Manage All Lead Distances</span>
            </h1>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                View and manage lead distances across all resources and rate cards.
            </p>
        </div>
                    ...
                    <div class="mt-4 space-y-4">
                        ...
                        <div>
                            ...
                            <select id="station_id" name="station_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white dark:bg-gray-700 dark:border-gray-600 dark:text-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                ...
                                {{-- Stations will be loaded via AJAX or passed if small list --}}
    ...
    $(document).ready(function() {
        ...
        $('#indexForm').on('submit', function(e) {
            ...
            if (id) {
                ...
                url = "/resources/" + resourceId + "/lead-distances";
                method = 'POST';
            }
