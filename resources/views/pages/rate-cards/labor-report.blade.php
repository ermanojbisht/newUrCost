...
@section('content')
    ...
    <div class="no-print">
        ...
        <div class="mt-4 glass rounded-xl p-4 shadow-lg">
            <div class="flex items-center gap-4">
                ...
                @if($sorId)
                    <a href="{{ route('rate-cards.labor-report', ['rate_card_id' => $rateCardId, 'effective_date' => $effectiveDate]) }}" 
    ...
    <div class="w-full">
        ...
        <div class="glass rounded-2xl overflow-hidden shadow-lg print-border">
            <table id="labor-rates-table" class="w-full text-left border-collapse display compact">
                <thead>
                    <tr class="bg-gray-100/50 dark:bg-gray-800/50 border-b border-gray-200 dark:border-gray-700 text-xs uppercase tracking-wider text-gray-600 dark:text-gray-400">
                        ...
                        <th class="py-2 px-3 font-semibold text-right">Index Cost</th>
                ...
                <tbody class="text-sm divide-y divide-gray-200 dark:divide-gray-700">
                    @foreach($reportData as $index => $data)
                        <tr class="hover:bg-white/50 dark:hover:bg-gray-800/50 transition-colors">
                            ...
                            <td class="py-2 px-3 text-right font-mono text-gray-500 dark:text-gray-500">{{ number_format($data['index_cost'], 2) }}</td>
