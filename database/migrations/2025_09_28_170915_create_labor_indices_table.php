...
return new class extends Migration
{
    ...
    {
        Schema::create('labor_indices', function (Blueprint $table) {
            // Old Column Name: ID, New Column Name: id, Data Type: bigIncrements, Description: Primary key for the table.
            $table->bigIncrements('id');
            // Old Column Name: ResID, New Column Name: resource_id, Data Type: unsignedBigInteger, Description: The ID of the resource. Foreign key to the resources table. if one 1 then it means it is applicable to all labor resources if for a particular resource no value is avilable
    ...
    {
        Schema::dropIfExists('labor_indices');
    }
};
