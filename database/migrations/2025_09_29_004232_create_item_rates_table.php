...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('item_rates', function (Blueprint $table) {
            ...
            // Added: Auto-increment primary key required by Eloquent
            // This solves the “Illegal offset type” error.
            $table->bigIncrements('id');  // Added
            ...
            $table->decimal('machine_cost', 15, 2);
            ...
            $table->decimal('overhead_cost', 15, 2);
            ...
            // Added: indexes for performance & rate-version validation
            $table->index(['item_code', 'rate_card_id', 'valid_from']); // Added
            $table->index(['item_code', 'rate_card_id', 'valid_to']);   // Added
