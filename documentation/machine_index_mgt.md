# Machine Index Management Process

## Overview
The Machine Index system allows for the adjustment of base machine rates based on specific Rate Cards and time periods. This ensures that cost estimations remain accurate across different project conditions and timelines without modifying the core resource base rates.
...
*   **Use Case**: When a specific machine (e.g., "Excavator 20T") has a unique rate adjustment for a specific project/rate card.
...
*   **Use Case**: General adjustments applicable to ALL machine resources for a specific Rate Card (e.g., "Fuel Price Adjustment" applying to all machinery).
